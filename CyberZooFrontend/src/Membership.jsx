...
const Membership = ({
  ...
  const handleJoinMembership = (membership, customerId) => {
    if (membership.tier === "Explorer" && userAge > 16) {
      ...
      console.log("Joining membership:", customerId);
                ...
                <td key={membership.id} style={styles.cell}>
                  {userRole === "admin" ? (
                    ...
                    <button
                      style={styles.button}
                      onClick={() =>
                        handleJoinMembership(membership, customerId)
                      }
                    >
                      Join
                    </button>
                    ...
                    <button
                      style={styles.button}
                      onClick={() =>
                        handleChangeMembership(membership, customerId)
                      }
                    >
                      Switch
                    </button>
                    ...
                    <button
                      ...
                      onClick={() => handleCancelMembership(customerId)}
                    >
                      Cancel
                    </button>
                  )}
