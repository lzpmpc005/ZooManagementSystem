...
function ManageTours() {
  ...
  async function deleteTour(id) {
    if (toBeDeleted !== id) {
      ...
      const confirmed = window.confirm(
        "Are you sure you want to delete this tour? Click OK to confirm."
      );
      if (!confirmed) {
        return;
      }
    ...
    try {
      const response = await fetch(
        `http://127.0.0.1:8000/api/delete_tour/${id}/`,
        {
          method: "POST",
        }
      );
    ...
    useMultistepForm(
      [
        ...
        },
        {
          component: TourForm3,
          props: {
            habitat1_id: data.habitat1_id,
            leave_time1: data.leave_time1,
            ...data,
            updateFields,
          },
        },
        {
          component: TourForm4,
          props: {
            habitat2_id: data.habitat2_id,
            leave_time2: data.leave_time2,
            ...data,
            updateFields,
          },
        },
        {
          component: TourForm5,
          props: {
            habitat3_id: data.habitat3_id,
            leave_time3: data.leave_time3,
            ...data,
            updateFields,
          },
        },
        {
          component: TourForm6,
          props: {
            habitat4_id: data.habitat4_id,
            leave_time4: data.leave_time4,
            ...data,
            updateFields,
          },
        },
        {
          component: TourForm7,
          props: {
            habitat5_id: data.habitat5_id,
            leave_time5: data.leave_time5,
            ...data,
            updateFields,
          },
        },
  ...
  function validateStep(stepData) {
    if (currentStepIndex === 1) {
      ...
      const leaveTime1 = convertTimeToInt(
